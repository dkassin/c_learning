...
// It's up to the call to free() this pointer when done with it.

// Note that this strips the newline from the result.
// If you need it in there, probably best to switch this to a do-while.
...
char *readline(FILE *fp)
{
    ...
    while (c = fgetc(fp), c != '\n' && c != EOF) {
        ...
        // Check if were out of the room in the buffer accounting
    ...
    // And return NULL to indicte we're at EOF:
